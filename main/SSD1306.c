...
//----- Auxiliary data ------//
uint8_t __GLCD_Buffer[__GLCD_Buffer_Sizes];
...
//#define BitToggle(x, y) (x ^= (1L<<y))
//#define BitCheck(x, y) (x & (1L<<y) ? 1 : 0 )
//---------------------------//
...
void GLCD_Setup(void)
	...
	GLCD_SendCommand(0x80);											//Suggest ratio
