...
/*
||      128x64  -  0      GLCD_128x64
||      128x32  -  1     GLCD_128x32
||      96x16   -  2     GLCD_96x16
||
*/
#define GLCD_Size 1   ///GLCD_128x32
///#define GLCD_Size GLCD_96x12
...
#if GLCD_Size == 0 ///GLCD_128x64
	#define __GLCD_Screen_Width	128
	#define __GLCD_Screen_Height	64
        #define __GLCD_Screen_Lines	8
        #define __GLCD_Buffer_Sizes     1024
#elif GLCD_Size == 1 ///GLCD_128x32
	#define __GLCD_Screen_Width     128
	#define __GLCD_Screen_Height   	32
	#define __GLCD_Screen_Lines     4
        #define __GLCD_Buffer_Sizes     512+128
#else
	#define __GLCD_Screen_Width    	96
	#define __GLCD_Screen_Height   	16
	#define __GLCD_Screen_Lines     2
        #define __GLCD_Buffer_Sizes     192
#endif
